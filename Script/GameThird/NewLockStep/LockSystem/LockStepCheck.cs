...
using System.Linq;
namespace LockStep {
    public class LockStepCheck {
        private bool IsNoPlayBack = true;
        private bool IsHaveError = false;
        private bool IsStart = false;
        private int sum = 0;
        private static LockStepCheck _instance;
        private LockStepCheck() {

        }
        public static LockStepCheck getIntance() {
            if(_instance == null) {
                _instance = new LockStepCheck();
            }
            return _instance;
        }
        //============================================= 外部调用 =========================================
        //游戏开始时调用
        public void GameStart(GameObject go, bool isPlayBack) {
            IsStart = true;
            IsNoPlayBack = !isPlayBack;
